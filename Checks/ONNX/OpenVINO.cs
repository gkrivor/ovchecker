...
namespace OVChecker
{
    static public class ONNXOpenVINOChecks
    {
        ...
        {
            AddCustomizations(OVChecksDescriptions.RegisterDescription(OVFrontends.ONNX, "OpenVINO Frontend API Convert Partially", "import openvino as ov\n" +
                "import openvino.frontend as of\n" +
                "mngr = of.FrontEndManager()\n" +
                "f = mngr.load_by_framework(\"onnx\")\n" +
                "# OnBeforeCheck\n" +
                "l = f.load(\"%MODEL_PATH%\")\n" +
